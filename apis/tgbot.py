...
async def button(update: Update, context):
    ...
    # Пробный ключ Франция
        ...
        key = await client.get_trial_subscription(telegram_id=str(user_id), param='france')
    ...
    # Обычный ключ Франция
        ...
        key = await client.get_subscription(telegram_id=str(user_id), param='france')
    ...
    # Тестовый ключ Германия
        ...
        base_url = 'http://dominikana.linkpc.net:20567/dashboard/'
        yours_username = 'admin1'
        yours_password = 'eaa4e3629096d174f0dbd41771ce1185'
        ssl = False
        ...
        key = await client.get_trial_subscription(telegram_id=str(user_id), param='germany')
    ...
    # Обычный ключ Германия
        ...
        key = await client.get_subscription(telegram_id=str(user_id), param='germany')
...
async def mykey(update: Update, context):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton(f"Test 🇫🇷", callback_data='key3')],
        [InlineKeyboardButton(f"🇫🇷", callback_data='key4')],
        [InlineKeyboardButton(f"Test 🇩🇪", callback_data='key5')],
...
def main():
    application = Application.builder().token("7653004724:AAEuHpypQ4k_Su5S8oLmHBXAGzZv0evhj_s").build()
